...
function diffArtifact(overrides: Partial<DiffArtifact> = {}): DiffArtifact {
  return {
    ...
    summary: { regressions: 1, recoveries: 1, unchanged: 1, added: 1, removed: 1, schemaDriftCount: 1, responseChangeCount: 1, gate: "fail" },
    ...
    schemaDrift: [{ capability: "tools", name: "create_issue", changes: ["added required property type"] }],
