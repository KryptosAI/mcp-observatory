...
Generated at 2026-09-02T04:14:25.709Z
...
_Analyzed at 2026-09-02T04:14:27.337Z_
...
| --- | --- | --- | --- | --- |
| healthy | conformance | pass | 1.50 | All 7 conformance checks passed. |
| healthy | prompts | pass | 0.93 | Advertised capability responded with the minimal expected shape (1 item). |
| healthy | runtime-profile | pass | 0.09 | Detected 0 potential egress target(s) and 4 potential state mutation(s) with low confidence. |
| healthy | security-lite | pass | 0.03 | No security issues detected (lightweight scan). |
| healthy | tools | pass | 2.29 | Advertised capability responded with the minimal expected shape (7 items). |
| review | schema-quality | partial | 0.89 | Found 1 quality finding(s) across 8 item(s): 0 warnings, 1 info. |
...
- Endpoint: `prompts/list`
  ...
  - Diagnostics: Watching for changes in prompts directory: ./examples/promptopia-prompts, promptopia-mcp MCP server running (v1.1.0)
...
- Run ID: `run_2026-09-02T041425709Z_2df3a73d`
- Gate: `pass`
