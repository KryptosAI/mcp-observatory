...
Generated at 2026-07-15T22:35:57.353Z

## Target and Environment Metadata

- Target: `nadra-mcp`
- Adapter: `local-process`
- Command: `npx -y nadra-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `nadra-mcp`.
Command: npx -y nadra-mcp
...
Recent stderr:
- npm error 404  'nadra-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_57_428Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223557353Z_5a3f2a63`
- Gate: `fail`
