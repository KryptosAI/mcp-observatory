...
Generated at 2026-07-15T22:35:53.573Z

## Target and Environment Metadata

- Target: `jazzcash-mcp`
- Adapter: `local-process`
- Command: `npx -y @theyahia/jazzcash-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `jazzcash-mcp`.
Command: npx -y @theyahia/jazzcash-mcp
...
Recent stderr:
- [jazzcash-mcp] Fatal: Environment variables JAZZCASH_MERCHANT_ID, JAZZCASH_PASSWORD, and JAZZCASH_INTEGRITY_SALT are required. Get credentials from the JazzCash merchant portal.
```
...
- Run ID: `run_2026-07-15T223553573Z_80f6583c`
- Gate: `fail`
