...
Generated at 2026-07-15T22:33:39.656Z

## Target and Environment Metadata

- Target: `stripe-server`
...
```text
Could not establish a plain stdio MCP session for target `stripe-server`.
Command: npx -y @stripe/mcp
...
- Run ID: `run_2026-07-15T223339656Z_3e5a87c3`
- Gate: `fail`
