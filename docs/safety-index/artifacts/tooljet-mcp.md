...
Generated at 2026-07-15T22:35:10.686Z

## Target and Environment Metadata

- Target: `tooljet-mcp`
- Adapter: `local-process`
- Command: `npx -y tooljet-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `tooljet-mcp`.
Command: npx -y tooljet-mcp
...
Recent stderr:
- npm error 404  'tooljet-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_10_758Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223510686Z_66fb5eb7`
- Gate: `fail`
