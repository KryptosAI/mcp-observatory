...
Generated at 2026-07-12T23:44:34.571Z

## Target and Environment Metadata

- Target: `google-calendar-server`
...
```text
Could not establish a plain stdio MCP session for target `google-calendar-server`.
Command: npx -y @anthropic/mcp-server-google-calendar
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-12T23_44_34_663Z-debug-0.log
```
...
- Run ID: `run_2026-07-12T234434571Z_4c1be932`
- Gate: `fail`
