...
Generated at 2026-07-15T22:35:59.152Z

## Target and Environment Metadata

- Target: `hec-pakistan-mcp`
- Adapter: `local-process`
- Command: `npx -y hec-pakistan-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `hec-pakistan-mcp`.
Command: npx -y hec-pakistan-mcp
...
Recent stderr:
- npm error 404  'hec-pakistan-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_59_233Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223559152Z_37190a9a`
- Gate: `fail`
