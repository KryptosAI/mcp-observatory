...
Generated at 2026-07-15T22:35:50.180Z

## Target and Environment Metadata

- Target: `punjab-health-mcp`
- Adapter: `local-process`
- Command: `npx -y punjab-health-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `punjab-health-mcp`.
Command: npx -y punjab-health-mcp
...
Recent stderr:
- npm error 404  'punjab-health-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_50_261Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223550180Z_9028920c`
- Gate: `fail`
