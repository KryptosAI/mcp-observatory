...
Generated at 2026-07-15T22:35:08.175Z

## Target and Environment Metadata

- Target: `gupshup-mcp`
- Adapter: `local-process`
- Command: `npx -y gupshup-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `gupshup-mcp`.
Command: npx -y gupshup-mcp
...
Recent stderr:
- npm error 404  'gupshup-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_08_242Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223508175Z_ec02452e`
- Gate: `fail`
