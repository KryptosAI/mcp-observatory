...
Generated at 2026-07-15T22:34:45.024Z

## Target and Environment Metadata

- Target: `whatsapp-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `whatsapp-mcp-server`.
Command: npx -y whatsapp-mcp
...
- Run ID: `run_2026-07-15T223445024Z_107be963`
- Gate: `fail`
