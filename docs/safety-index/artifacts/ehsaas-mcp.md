...
Generated at 2026-07-15T22:35:49.281Z

## Target and Environment Metadata

- Target: `ehsaas-mcp`
- Adapter: `local-process`
- Command: `npx -y ehsaas-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `ehsaas-mcp`.
Command: npx -y ehsaas-mcp
...
Recent stderr:
- npm error 404  'ehsaas-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_49_361Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223549281Z_3afd0d18`
- Gate: `fail`
