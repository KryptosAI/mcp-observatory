...
Generated at 2026-07-15T22:35:07.858Z

## Target and Environment Metadata

- Target: `whatsapp-business-mcp`
- Adapter: `local-process`
- Command: `npx -y whatsapp-business-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `whatsapp-business-mcp`.
Command: npx -y whatsapp-business-mcp
...
Recent stderr:
- npm error 404  'whatsapp-business-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_07_931Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223507858Z_107894d8`
- Gate: `fail`
