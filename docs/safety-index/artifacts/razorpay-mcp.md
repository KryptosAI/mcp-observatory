...
Generated at 2026-07-15T22:35:04.923Z

## Target and Environment Metadata

- Target: `razorpay-mcp`
- Adapter: `local-process`
- Command: `npx -y razorpay-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `razorpay-mcp`.
Command: npx -y razorpay-mcp
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_04_996Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223504923Z_d539a063`
- Gate: `fail`
