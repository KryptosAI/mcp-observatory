...
Generated at 2026-07-15T17:56:19.371Z

## Target and Environment Metadata

- Target: `spotify-server`
- Adapter: `local-process`
- Command: `npx -y spotify-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `spotify-server`.
Command: npx -y spotify-mcp-server
...
Recent stderr:
- npm error 404  'spotify-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_19_441Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175619371Z_170f3ef1`
- Gate: `fail`
