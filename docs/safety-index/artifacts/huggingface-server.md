...
Generated at 2026-07-15T22:33:52.569Z

## Target and Environment Metadata

- Target: `huggingface-server`
- Adapter: `local-process`
- Command: `npx -y @anthropic/mcp-server-huggingface`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `huggingface-server`.
Command: npx -y @anthropic/mcp-server-huggingface
...
Recent stderr:
- npm error 404  '@anthropic/mcp-server-huggingface@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_33_52_643Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223352569Z_ff54b58b`
- Gate: `fail`
