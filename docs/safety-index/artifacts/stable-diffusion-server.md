...
Generated at 2026-07-15T17:56:05.269Z

## Target and Environment Metadata

- Target: `stable-diffusion-server`
- Adapter: `local-process`
- Command: `npx -y stable-diffusion-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `stable-diffusion-server`.
Command: npx -y stable-diffusion-mcp-server
...
Recent stderr:
- npm error 404  'stable-diffusion-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_05_347Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175605269Z_89e51688`
- Gate: `fail`
