...
Generated at 2026-07-15T22:35:51.665Z

## Target and Environment Metadata

- Target: `zong-mcp`
- Adapter: `local-process`
- Command: `npx -y zong-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `zong-mcp`.
Command: npx -y zong-mcp
...
Recent stderr:
- npm error 404  'zong-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_51_745Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223551665Z_5e15f3cd`
- Gate: `fail`
