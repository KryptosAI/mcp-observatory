...
Generated at 2026-07-15T22:35:49.694Z

## Target and Environment Metadata

- Target: `pims-mcp`
- Adapter: `local-process`
- Command: `npx -y pims-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pims-mcp`.
Command: npx -y pims-mcp
...
Recent stderr:
- npm error 404  'pims-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_49_773Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223549694Z_d5dcfc60`
- Gate: `fail`
