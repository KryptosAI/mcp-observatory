...
Generated at 2026-07-15T22:35:06.823Z

## Target and Environment Metadata

- Target: `digilocker-mcp`
- Adapter: `local-process`
- Command: `npx -y digilocker-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `digilocker-mcp`.
Command: npx -y digilocker-mcp
...
Recent stderr:
- npm error 404  'digilocker-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_06_894Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223506823Z_384f59e6`
- Gate: `fail`
