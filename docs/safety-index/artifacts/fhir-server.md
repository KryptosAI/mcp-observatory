...
Generated at 2026-07-15T22:33:58.466Z

## Target and Environment Metadata

- Target: `fhir-server`
- Adapter: `local-process`
- Command: `npx -y fhir-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `fhir-server`.
Command: npx -y fhir-mcp-server
...
- Run ID: `run_2026-07-15T223358466Z_72d03650`
- Gate: `fail`
