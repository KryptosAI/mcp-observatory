...
Generated at 2026-07-15T22:36:00.597Z

## Target and Environment Metadata

- Target: `bhuvan-mcp`
- Adapter: `local-process`
- Command: `npx -y bhuvan-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `bhuvan-mcp`.
Command: npx -y bhuvan-mcp
...
Recent stderr:
- npm error 404  'bhuvan-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_36_00_675Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223600597Z_47db61ca`
- Gate: `fail`
