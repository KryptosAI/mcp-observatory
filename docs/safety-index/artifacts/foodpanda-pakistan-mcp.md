...
Generated at 2026-07-15T22:36:01.442Z

## Target and Environment Metadata

- Target: `foodpanda-pakistan-mcp`
- Adapter: `local-process`
- Command: `npx -y foodpanda-pakistan-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `foodpanda-pakistan-mcp`.
Command: npx -y foodpanda-pakistan-mcp
...
Recent stderr:
- npm error 404  'foodpanda-pakistan-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_36_01_517Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223601442Z_a60172b9`
- Gate: `fail`
