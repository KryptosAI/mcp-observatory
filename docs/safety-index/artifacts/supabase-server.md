...
Generated at 2026-07-12T23:36:07.506Z

## Target and Environment Metadata

- Target: `supabase-server`
...
```text
Could not establish a plain stdio MCP session for target `supabase-server`.
Command: npx -y @supabase/mcp-server-supabase
...
- Run ID: `run_2026-07-12T233607506Z_c4e4d208`
- Gate: `fail`
