...
Generated at 2026-07-15T22:36:02.432Z

## Target and Environment Metadata

- Target: `olx-pakistan-mcp`
- Adapter: `local-process`
- Command: `npx -y olx-pakistan-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `olx-pakistan-mcp`.
Command: npx -y olx-pakistan-mcp
...
Recent stderr:
- npm error 404  'olx-pakistan-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_36_02_517Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223602432Z_cfed5c8a`
- Gate: `fail`
