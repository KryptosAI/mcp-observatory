...
Generated at 2026-07-15T17:56:07.393Z

## Target and Environment Metadata

- Target: `raspberrypi-server`
- Adapter: `local-process`
- Command: `npx -y raspberrypi-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `raspberrypi-server`.
Command: npx -y raspberrypi-mcp-server
...
Recent stderr:
- npm error 404  'raspberrypi-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_07_490Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175607393Z_15e17c0d`
- Gate: `fail`
