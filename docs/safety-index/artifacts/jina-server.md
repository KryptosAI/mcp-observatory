...
Generated at 2026-07-15T22:33:51.124Z

## Target and Environment Metadata

- Target: `jina-server`
- Adapter: `local-process`
- Command: `npx -y @anthropic/mcp-server-jina`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `jina-server`.
Command: npx -y @anthropic/mcp-server-jina
...
Recent stderr:
- npm error 404  '@anthropic/mcp-server-jina@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_33_51_200Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223351124Z_036dd713`
- Gate: `fail`
