...
Generated at 2026-07-15T22:35:08.496Z

## Target and Environment Metadata

- Target: `textlocal-mcp`
- Adapter: `local-process`
- Command: `npx -y textlocal-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `textlocal-mcp`.
Command: npx -y textlocal-mcp
...
Recent stderr:
- npm error 404  'textlocal-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_08_565Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223508496Z_efc7304a`
- Gate: `fail`
