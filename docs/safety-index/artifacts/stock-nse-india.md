...
Generated at 2026-07-15T22:35:04.585Z

## Target and Environment Metadata

- Target: `stock-nse-india`
- Adapter: `local-process`
- Command: `npx -y stock-nse-india-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `stock-nse-india`.
Command: npx -y stock-nse-india-mcp
...
Recent stderr:
- npm error 404  'stock-nse-india-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_04_649Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223504585Z_8fb1ad0f`
- Gate: `fail`
