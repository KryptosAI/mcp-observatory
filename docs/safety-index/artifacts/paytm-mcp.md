...
Generated at 2026-07-15T22:35:05.292Z

## Target and Environment Metadata

- Target: `paytm-mcp`
- Adapter: `local-process`
- Command: `npx -y paytm-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `paytm-mcp`.
Command: npx -y paytm-mcp
...
Recent stderr:
- npm error 404  'paytm-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_05_364Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223505292Z_b77e716c`
- Gate: `fail`
