...
Generated at 2026-07-15T22:35:09.178Z

## Target and Environment Metadata

- Target: `ola-maps-mcp`
- Adapter: `local-process`
- Command: `npx -y ola-maps-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `ola-maps-mcp`.
Command: npx -y ola-maps-mcp
...
Recent stderr:
- npm error 404  'ola-maps-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_09_248Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223509178Z_bd7a7832`
- Gate: `fail`
