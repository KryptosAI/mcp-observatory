...
Generated at 2026-07-15T17:30:08.338Z

## Target and Environment Metadata

- Target: `langfuse-mcp`
- Adapter: `local-process`
- Command: `npx -y langfuse-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `langfuse-mcp`.
Command: npx -y langfuse-mcp
...
Recent stderr:
- langfuse-mcp: Invalid Langfuse configuration:
...
- Run ID: `run_2026-07-15T173008337Z_74962406`
- Gate: `fail`
