...
Generated at 2026-07-15T22:35:11.362Z

## Target and Environment Metadata

- Target: `chatwoot-mcp`
- Adapter: `local-process`
- Command: `npx -y chatwoot-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `chatwoot-mcp`.
Command: npx -y chatwoot-mcp
...
Recent stderr:
- 2026/07/15 15:35:43 Failed to initialize Chatwoot client: CHATWOOT_URL environment variable is required
```
...
- Run ID: `run_2026-07-15T223511362Z_6857c47e`
- Gate: `fail`
