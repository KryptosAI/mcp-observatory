...
Generated at 2026-07-15T22:34:28.027Z

## Target and Environment Metadata

- Target: `azure-devops-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `azure-devops-mcp-server`.
Command: npx -y @azure-devops/mcp
...
Recent stderr:
- -t, --tenant          Azure tenant ID (optional, applied when using
- 'interactive' and 'azcli' type of authentication)
- [string]
...
- Run ID: `run_2026-07-15T223428027Z_917b65c2`
- Gate: `fail`
