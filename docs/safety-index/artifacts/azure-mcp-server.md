...
Generated at 2026-07-15T22:34:19.772Z

## Target and Environment Metadata

- Target: `azure-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `azure-mcp-server`.
Command: npx -y @azure/mcp
...
- Run ID: `run_2026-07-15T223419772Z_796dd3a0`
- Gate: `fail`
