...
Generated at 2026-07-15T22:35:50.667Z

## Target and Environment Metadata

- Target: `pakistan-weather-mcp`
- Adapter: `local-process`
- Command: `npx -y pakistan-weather-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pakistan-weather-mcp`.
Command: npx -y pakistan-weather-mcp
...
Recent stderr:
- npm error 404  'pakistan-weather-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_50_762Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223550667Z_7d21e5ab`
- Gate: `fail`
