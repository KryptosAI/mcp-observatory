...
Generated at 2026-07-22T21:37:04.288Z

## Target and Environment Metadata

- Target: `google-drive-server`
...
```text
Could not establish a plain stdio MCP session for target `google-drive-server`.
Command: npx -y @modelcontextprotocol/server-google-drive
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-22T21_37_04_366Z-debug-0.log
```
...
- Run ID: `run_2026-07-22T213704288Z_02d54b15`
- Gate: `fail`
