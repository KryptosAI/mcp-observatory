...
Generated at 2026-07-15T22:35:08.847Z

## Target and Environment Metadata

- Target: `mapmyindia-mcp`
- Adapter: `local-process`
- Command: `npx -y mapmyindia-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `mapmyindia-mcp`.
Command: npx -y mapmyindia-mcp
...
Recent stderr:
- npm error 404  'mapmyindia-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_08_919Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223508847Z_60ce0fdb`
- Gate: `fail`
