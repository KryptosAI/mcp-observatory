...
Generated at 2026-07-15T17:56:53.180Z

## Target and Environment Metadata

- Target: `argocd-mcp-server`
- Adapter: `local-process`
- Command: `npx -y argocd-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `argocd-mcp-server`.
Command: npx -y argocd-mcp
...
Recent stderr:
- argocd-mcp http   Start ArgoCD MCP server using Http Stream.
- Options:
...
- Run ID: `run_2026-07-15T175653180Z_3a3063cc`
- Gate: `fail`
