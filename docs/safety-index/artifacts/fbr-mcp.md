...
Generated at 2026-07-15T22:35:57.826Z

## Target and Environment Metadata

- Target: `fbr-mcp`
- Adapter: `local-process`
- Command: `npx -y fbr-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `fbr-mcp`.
Command: npx -y fbr-mcp
...
Recent stderr:
- npm error 404  'fbr-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_57_911Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223557826Z_a2c9a1d6`
- Gate: `fail`
