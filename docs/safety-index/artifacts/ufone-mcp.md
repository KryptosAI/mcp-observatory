...
Generated at 2026-07-15T22:35:52.658Z

## Target and Environment Metadata

- Target: `ufone-mcp`
- Adapter: `local-process`
- Command: `npx -y ufone-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `ufone-mcp`.
Command: npx -y ufone-mcp
...
Recent stderr:
- npm error 404  'ufone-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_52_731Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223552658Z_69a2e94d`
- Gate: `fail`
