...
Generated at 2026-07-15T22:35:11.041Z
...
```text
Could not establish a plain stdio MCP session for target `appwrite-mcp`.
Command: npx -y appwrite-mcp
...
Recent stderr:
- npm error 404  'appwrite-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_11_114Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223511041Z_235fd95c`
- Gate: `fail`
