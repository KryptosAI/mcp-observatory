...
Generated at 2026-07-15T17:29:15.846Z

## Target and Environment Metadata

- Target: `youtube-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `youtube-mcp-server`.
Command: npx -y youtube-mcp-server
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_29_15_961Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T172915846Z_508e6917`
- Gate: `fail`
