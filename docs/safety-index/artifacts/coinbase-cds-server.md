...
- Target: `coinbase-cds-server`
- Adapter: `local-process`
- Command: `npx -y @coinbase/cds-mcp-server`
- Server: `cds 9.6.6`
...
- Endpoint: `tools/list`
  ...
  - Minimal shape present: `true`
  - Item count: `2`
  - Identifiers: list-cds-routes, get-cds-doc
  - Diagnostics: [CDS MCP] 🚀 Starting MCP Server version 9.6.6
