...
Generated at 2026-07-15T22:34:03.943Z

## Target and Environment Metadata

- Target: `openweather-server`
- Adapter: `local-process`
- Command: `npx -y openweather-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `openweather-server`.
Command: npx -y openweather-mcp-server
...
Recent stderr:
- npm error 404  'openweather-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_34_04_019Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223403943Z_468bc3ec`
- Gate: `fail`
