...
Generated at 2026-07-15T22:34:00.360Z

## Target and Environment Metadata

- Target: `canvas-server`
- Adapter: `local-process`
- Command: `npx -y canvas-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `canvas-server`.
Command: npx -y canvas-mcp-server
...
- - CANVAS_DOMAIN: Your Canvas domain (e.g., school.instructure.com)
```
...
- Run ID: `run_2026-07-15T223400360Z_c32d7bb7`
- Gate: `fail`
