...
Generated at 2026-07-15T17:56:09.729Z

## Target and Environment Metadata

- Target: `unity-server`
- Adapter: `local-process`
- Command: `npx -y unity-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `unity-server`.
Command: npx -y unity-mcp-server
...
Recent stderr:
- UNITY_PROJECT_PATH is required. Set it in your MCP client config (e.g. Cursor) to your Unity project root.
```
...
- Run ID: `run_2026-07-15T175609729Z_5605fae7`
- Gate: `fail`
