...
Generated at 2026-07-15T17:56:14.344Z

## Target and Environment Metadata

- Target: `zillow-server`
- Adapter: `local-process`
- Command: `npx -y zillow-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `zillow-server`.
Command: npx -y zillow-mcp-server
...
Recent stderr:
- sh: zillow-mcp-server: command not found
```
...
- Run ID: `run_2026-07-15T175614344Z_758eb821`
- Gate: `fail`
