...
Generated at 2026-07-15T22:35:47.398Z

## Target and Environment Metadata

- Target: `aqi-india-mcp`
- Adapter: `local-process`
- Command: `npx -y aqi-india-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `aqi-india-mcp`.
Command: npx -y aqi-india-mcp
...
Recent stderr:
- npm error 404  'aqi-india-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_47_477Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223547398Z_7b69a48c`
- Gate: `fail`
