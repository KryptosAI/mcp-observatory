...
- Target: `mui-mcp-server`
- Adapter: `local-process`
- Command: `npx -y @mui/mcp`
- Server: `mui-mcp 0.1.1`
...
| --- | --- | --- | --- |
| Design tool context. Use the `figma` variant when the host has a Figma frame in scope; `opaque` is the escape hatch for other tools (Penpot, Sketch, screenshots). | unknown | description_analysis | medium |
...
Summary: Detected 1 potential egress target(s) and 1 potential state mutation(s) with low confidence.
...
- Endpoint: `runtime-profile/analyze`
  ...
  - Item count: `2`
  - Identifiers: none
  - Diagnostics: Egress entries: 1, State mutations: 1, Confidence: medium
...
- Endpoint: `tools/list`
  ...
  - Minimal shape present: `true`
  - Item count: `2`
  - Identifiers: generateReactCode, fetchDocs
  - Diagnostics: none
