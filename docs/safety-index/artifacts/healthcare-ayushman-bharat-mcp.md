...
Generated at 2026-07-15T22:35:46.541Z

## Target and Environment Metadata

- Target: `healthcare-ayushman-bharat-mcp`
- Adapter: `local-process`
- Command: `npx -y healthcare-ayushman-bharat-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `healthcare-ayushman-bharat-mcp`.
Command: npx -y healthcare-ayushman-bharat-mcp
...
Recent stderr:
- npm error 404  'healthcare-ayushman-bharat-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_46_605Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223546541Z_18af4e7f`
- Gate: `fail`
