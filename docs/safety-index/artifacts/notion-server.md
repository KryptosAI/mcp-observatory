...
Generated at 2026-07-12T23:44:22.045Z
...
_Analyzed at 2026-07-12T23:44:22.854Z_
...
| --- | --- | --- | --- | --- |
| healthy | conformance | pass | 205.06 | All 7 conformance checks passed. |
| healthy | runtime-profile | pass | 0.17 | Detected 10 potential egress target(s) and 21 potential state mutation(s) with low confidence. |
| healthy | security | pass | 3.78 | No security issues detected. |
| healthy | security-lite | pass | 0.06 | No security issues detected (lightweight scan). |
| healthy | tools | pass | 1.80 | Advertised capability responded with the minimal expected shape (24 items). |
| review | attack-sim | partial | 3.11 | Safe attack simulation found 1 finding(s): 0 high, 1 medium, 0 low. |
| review | schema-quality | partial | 3.65 | Found 31 quality finding(s) across 24 item(s): 0 warnings, 31 info. |
...
- Run ID: `run_2026-07-12T234422045Z_8961b236`
- Gate: `pass`
