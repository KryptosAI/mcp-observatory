...
Generated at 2026-07-15T22:33:59.260Z

## Target and Environment Metadata

- Target: `epic-server`
- Adapter: `local-process`
- Command: `npx -y epic-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `epic-server`.
Command: npx -y epic-mcp-server
...
Recent stderr:
- npm error 404  'epic-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_33_59_330Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223359260Z_b1ff2625`
- Gate: `fail`
