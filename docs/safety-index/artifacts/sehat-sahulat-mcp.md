...
Generated at 2026-07-15T22:35:48.818Z

## Target and Environment Metadata

- Target: `sehat-sahulat-mcp`
- Adapter: `local-process`
- Command: `npx -y sehat-sahulat-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `sehat-sahulat-mcp`.
Command: npx -y sehat-sahulat-mcp
...
Recent stderr:
- npm error 404  'sehat-sahulat-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_48_899Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223548818Z_d88c729f`
- Gate: `fail`
