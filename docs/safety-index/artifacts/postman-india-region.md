...
Generated at 2026-07-15T22:35:09.559Z

## Target and Environment Metadata

- Target: `postman-india-region`
...
```text
Could not establish a plain stdio MCP session for target `postman-india-region`.
Command: npx -y @postman/postman-mcp-server
...
Recent stderr:
- Invalid environment variables for Postman MCP server: { _errors: [], POSTMAN_API_KEY: { _errors: [ 'Required' ] } }
```
...
- Run ID: `run_2026-07-15T223509559Z_06abc877`
- Gate: `fail`
