...
Generated at 2026-07-12T23:44:36.895Z

## Target and Environment Metadata

- Target: `clay-server`
- Adapter: `local-process`
- Command: `npx -y @anthropic/mcp-server-clay`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `clay-server`.
Command: npx -y @anthropic/mcp-server-clay
...
Recent stderr:
- npm error 404  '@anthropic/mcp-server-clay@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-12T23_44_36_970Z-debug-0.log
```
...
- Run ID: `run_2026-07-12T234436895Z_9fe95c8f`
- Gate: `fail`
