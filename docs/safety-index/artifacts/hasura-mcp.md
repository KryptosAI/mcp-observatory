...
Generated at 2026-07-15T22:35:10.342Z

## Target and Environment Metadata

- Target: `hasura-mcp`
- Adapter: `local-process`
- Command: `npx -y hasura-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `hasura-mcp`.
Command: npx -y hasura-mcp
...
Recent stderr:
- npm error 404  'hasura-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_10_408Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223510342Z_f427c7f2`
- Gate: `fail`
