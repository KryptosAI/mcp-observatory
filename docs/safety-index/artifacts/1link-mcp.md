...
Generated at 2026-07-15T22:35:58.270Z

## Target and Environment Metadata

- Target: `1link-mcp`
- Adapter: `local-process`
- Command: `npx -y 1link-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `1link-mcp`.
Command: npx -y 1link-mcp
...
Recent stderr:
- npm error 404  '1link-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_58_350Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223558270Z_ac02125e`
- Gate: `fail`
