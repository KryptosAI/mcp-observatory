...
Generated at 2026-07-15T17:57:13.505Z

## Target and Environment Metadata

- Target: `aws-mcp-server`
- Adapter: `local-process`
- Command: `npx -y mcp-server-aws`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `aws-mcp-server`.
Command: npx -y mcp-server-aws
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_57_13_587Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175713505Z_f5cc7fb2`
- Gate: `fail`
