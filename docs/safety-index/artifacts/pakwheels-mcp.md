...
Generated at 2026-07-15T22:36:02.877Z

## Target and Environment Metadata

- Target: `pakwheels-mcp`
- Adapter: `local-process`
- Command: `npx -y pakwheels-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pakwheels-mcp`.
Command: npx -y pakwheels-mcp
...
Recent stderr:
- npm error 404  'pakwheels-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_36_02_953Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223602877Z_a0cc5369`
- Gate: `fail`
