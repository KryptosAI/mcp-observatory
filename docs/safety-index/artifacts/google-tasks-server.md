...
Generated at 2026-07-12T23:44:35.050Z

## Target and Environment Metadata

- Target: `google-tasks-server`
...
```text
Could not establish a plain stdio MCP session for target `google-tasks-server`.
Command: npx -y @anthropic/mcp-server-google-tasks
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-12T23_44_35_135Z-debug-0.log
```
...
- Run ID: `run_2026-07-12T234435050Z_5916222a`
- Gate: `fail`
