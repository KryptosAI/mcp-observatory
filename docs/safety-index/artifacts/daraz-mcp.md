...
Generated at 2026-07-15T22:36:01.900Z

## Target and Environment Metadata

- Target: `daraz-mcp`
- Adapter: `local-process`
- Command: `npx -y daraz-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `daraz-mcp`.
Command: npx -y daraz-mcp
...
Recent stderr:
- npm error 404  'daraz-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_36_01_975Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223601900Z_03d011e5`
- Gate: `fail`
