...
Generated at 2026-07-15T22:34:45.738Z

## Target and Environment Metadata

- Target: `shopify-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `shopify-mcp-server`.
Command: npx -y shopify-mcp
...
- Option 1 — Static access token (legacy apps):
...
- Run ID: `run_2026-07-15T223445738Z_0e225507`
- Gate: `fail`
