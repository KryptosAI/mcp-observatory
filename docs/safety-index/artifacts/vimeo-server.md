...
Generated at 2026-07-15T22:34:07.088Z

## Target and Environment Metadata

- Target: `vimeo-server`
- Adapter: `local-process`
- Command: `npx -y vimeo-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `vimeo-server`.
Command: npx -y vimeo-mcp-server
...
Recent stderr:
- npm error 404  'vimeo-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_34_07_161Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223407088Z_538c0527`
- Gate: `fail`
