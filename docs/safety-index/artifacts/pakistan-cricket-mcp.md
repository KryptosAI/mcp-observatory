...
Generated at 2026-07-15T22:35:59.622Z

## Target and Environment Metadata

- Target: `pakistan-cricket-mcp`
- Adapter: `local-process`
- Command: `npx -y pakistan-cricket-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pakistan-cricket-mcp`.
Command: npx -y pakistan-cricket-mcp
...
Recent stderr:
- npm error 404  'pakistan-cricket-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_59_702Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223559622Z_93ecbd1c`
- Gate: `fail`
