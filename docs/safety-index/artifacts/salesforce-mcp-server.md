...
Generated at 2026-07-15T17:56:40.684Z

## Target and Environment Metadata

- Target: `salesforce-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `salesforce-mcp-server`.
Command: npx -y @salesforce/mcp
...
Recent stderr:
- ›   providing services or functions that are relevant to use of the MCP server
...
- Run ID: `run_2026-07-15T175640684Z_d215b742`
- Gate: `fail`
