...
Generated at 2026-07-15T22:34:02.256Z

## Target and Environment Metadata

- Target: `mls-server`
- Adapter: `local-process`
- Command: `npx -y mls-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `mls-server`.
Command: npx -y mls-mcp-server
...
Recent stderr:
- npm error 404  'mls-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_34_02_325Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223402256Z_7f8cb8d0`
- Gate: `fail`
