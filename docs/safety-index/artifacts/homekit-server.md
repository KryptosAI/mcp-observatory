...
Generated at 2026-07-15T22:33:56.396Z

## Target and Environment Metadata

- Target: `homekit-server`
- Adapter: `local-process`
- Command: `npx -y homekit-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `homekit-server`.
Command: npx -y homekit-mcp-server
...
Recent stderr:
- npm error 404  'homekit-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_33_56_471Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223356396Z_d44348eb`
- Gate: `fail`
