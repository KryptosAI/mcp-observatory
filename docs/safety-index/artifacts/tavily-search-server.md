...
Generated at 2026-07-12T23:44:20.556Z

## Target and Environment Metadata

- Target: `tavily-search-server`
...
```text
Could not establish a plain stdio MCP session for target `tavily-search-server`.
Command: npx -y @anthropic/mcp-server-tavily
...
Recent stderr:
- npm error 404  '@anthropic/mcp-server-tavily@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-12T23_44_20_676Z-debug-0.log
```
...
- Run ID: `run_2026-07-12T234420556Z_0722789b`
- Gate: `fail`
