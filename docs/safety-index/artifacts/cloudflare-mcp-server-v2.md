...
Generated at 2026-07-15T17:56:58.976Z

## Target and Environment Metadata

- Target: `cloudflare-mcp-server-v2`
...
```text
Could not establish a plain stdio MCP session for target `cloudflare-mcp-server-v2`.
Command: npx -y @cloudflare/mcp-server-cloudflare
...
Recent stderr:
- [DEBUG 2026-07-15T17:56:59.988Z] Uncaught exception: Error: Unknown command: undefined. Expected 'init' or 'run'.
```
...
- Run ID: `run_2026-07-15T175658976Z_735f25f3`
- Gate: `fail`
