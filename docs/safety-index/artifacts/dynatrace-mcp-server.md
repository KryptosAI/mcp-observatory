...
Generated at 2026-07-15T22:34:29.884Z

## Target and Environment Metadata

- Target: `dynatrace-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `dynatrace-mcp-server`.
Command: npx -y @dynatrace-oss/dynatrace-mcp-server
...
- Run ID: `run_2026-07-15T223429884Z_dcc3d254`
- Gate: `fail`
