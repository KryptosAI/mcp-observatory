...
Generated at 2026-07-15T17:29:12.683Z

## Target and Environment Metadata

- Target: `arxiv-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `arxiv-mcp-server`.
Command: npx -y arxiv-mcp-server
...
- Run ID: `run_2026-07-15T172912683Z_528d3707`
- Gate: `fail`
