...
Generated at 2026-07-15T17:28:30.394Z

## Target and Environment Metadata

- Target: `openai-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `openai-mcp-server`.
Command: npx -y openai-mcp-server
...
Recent stderr:
- at file:///Users/williamweishuhn/.npm/_npx/6ddfc4319b8cf602/node_modules/openai-mcp-server/dist/index.js:10:16
...
- Run ID: `run_2026-07-15T172830394Z_7fca725c`
- Gate: `fail`
