...
Generated at 2026-07-15T17:56:12.323Z

## Target and Environment Metadata

- Target: `contract-analysis-server`
...
```text
Could not establish a plain stdio MCP session for target `contract-analysis-server`.
Command: npx -y contract-analysis-mcp
...
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_12_416Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175612323Z_f967db91`
- Gate: `fail`
