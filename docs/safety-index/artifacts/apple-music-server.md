...
Generated at 2026-07-15T17:56:19.987Z

## Target and Environment Metadata

- Target: `apple-music-server`
- Adapter: `local-process`
- Command: `npx -y apple-music-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `apple-music-server`.
Command: npx -y apple-music-mcp
...
- Run ID: `run_2026-07-15T175619987Z_048541f1`
- Gate: `fail`
