...
Generated at 2026-07-15T17:56:56.945Z

## Target and Environment Metadata

- Target: `postman-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `postman-mcp-server`.
Command: npx -y @postman/postman-mcp-server
...
- Run ID: `run_2026-07-15T175656945Z_3794bc9a`
- Gate: `fail`
