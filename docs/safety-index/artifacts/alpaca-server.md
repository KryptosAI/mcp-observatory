...
Generated at 2026-07-15T17:56:06.905Z

## Target and Environment Metadata

- Target: `alpaca-server`
- Adapter: `local-process`
- Command: `npx -y @alpacahq/alpaca-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `alpaca-server`.
Command: npx -y @alpacahq/alpaca-mcp-server
...
Recent stderr:
- npm error 404  '@alpacahq/alpaca-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_06_980Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175606905Z_4351e01f`
- Gate: `fail`
