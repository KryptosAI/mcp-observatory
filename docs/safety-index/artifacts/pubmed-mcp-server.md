...
Generated at 2026-07-15T17:30:08.340Z

## Target and Environment Metadata

- Target: `pubmed-mcp-server`
- Adapter: `local-process`
- Command: `npx -y pubmed-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pubmed-mcp-server`.
Command: npx -y pubmed-mcp-server
...
Recent stderr:
- /Users/williamweishuhn/.npm/_npx/930ee94f2d835167/node_modules/.bin/pubmed-mcp-server: line 1: use strict: command not found
- /Users/williamweishuhn/.npm/_npx/930ee94f2d835167/node_modules/.bin/pubmed-mcp-server: line 2: //#: No such file or directory
```
...
- Run ID: `run_2026-07-15T173008340Z_ec311fa0`
- Gate: `fail`
