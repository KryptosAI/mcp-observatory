...
Generated at 2026-07-15T22:35:46.962Z

## Target and Environment Metadata

- Target: `irctc-mcp`
- Adapter: `local-process`
- Command: `npx -y irctc-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `irctc-mcp`.
Command: npx -y irctc-mcp
...
Recent stderr:
- npm error 404  'irctc-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_47_041Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223546962Z_13fffc64`
- Gate: `fail`
