...
Generated at 2026-07-15T22:34:38.469Z

## Target and Environment Metadata

- Target: `shortcut-mcp-server`
...
```text
Could not establish a plain stdio MCP session for target `shortcut-mcp-server`.
Command: npx -y @shortcut/mcp
...
Recent stderr:
- A Shortcut api token is required.
```
...
- Run ID: `run_2026-07-15T223438469Z_748e4877`
- Gate: `fail`
