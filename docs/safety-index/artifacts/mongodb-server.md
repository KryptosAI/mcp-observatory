...
Generated at 2026-07-17T00:36:41.239Z

## Target and Environment Metadata

- Target: `mongodb-server`
- Adapter: `local-process`
- Command: `npx -y @anthropic/mcp-server-mongodb`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `mongodb-server`.
Command: npx -y @anthropic/mcp-server-mongodb
...
Recent stderr:
- npm error 404  The requested resource '@anthropic/mcp-server-mongodb@*' could not be found or you do not have permission to access it.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-17T00_36_41_311Z-debug-0.log
```
...
- Run ID: `run_2026-07-17T003641239Z_167a30e3`
- Gate: `fail`
