...
Generated at 2026-07-15T22:33:37.901Z
...
Recent stderr:
- npm error 404  '@anthropic/mcp-server-mongodb@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_33_37_976Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223337901Z_48f0dd9c`
- Gate: `fail`
