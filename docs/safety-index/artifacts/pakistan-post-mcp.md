...
Generated at 2026-07-15T22:35:53.117Z

## Target and Environment Metadata

- Target: `pakistan-post-mcp`
- Adapter: `local-process`
- Command: `npx -y pakistan-post-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `pakistan-post-mcp`.
Command: npx -y pakistan-post-mcp
...
Recent stderr:
- npm error 404  'pakistan-post-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_35_53_192Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223553117Z_18c2d067`
- Gate: `fail`
