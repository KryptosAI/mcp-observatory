...
Generated at 2026-07-15T22:34:03.595Z

## Target and Environment Metadata

- Target: `hotel-booking-server`
- Adapter: `local-process`
- Command: `npx -y hotel-booking-mcp`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `hotel-booking-server`.
Command: npx -y hotel-booking-mcp
...
Recent stderr:
- npm error 404  'hotel-booking-mcp@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T22_34_03_663Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T223403595Z_e22e43ea`
- Gate: `fail`
