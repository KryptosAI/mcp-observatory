...
Generated at 2026-07-15T17:56:11.839Z

## Target and Environment Metadata

- Target: `caselaw-server`
- Adapter: `local-process`
- Command: `npx -y caselaw-mcp-server`
- Server: `unknown `
...
```text
Could not establish a plain stdio MCP session for target `caselaw-server`.
Command: npx -y caselaw-mcp-server
...
Recent stderr:
- npm error 404  'caselaw-mcp-server@*' is not in this registry.
- npm error 404
- npm error 404 Note that you can also install from a
- npm error 404 tarball, folder, http url, or git url.
- npm error A complete log of this run can be found in: /Users/williamweishuhn/.npm/_logs/2026-07-15T17_56_11_927Z-debug-0.log
```
...
- Run ID: `run_2026-07-15T175611839Z_660c20d6`
- Gate: `fail`
