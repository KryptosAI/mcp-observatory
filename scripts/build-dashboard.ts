...
<head>
  ...
  <style>
    :root{color-scheme:dark;--bg:#29313e;--panel:rgba(34,43,56,.84);--line:rgba(132,211,213,.22);--muted:#b4c2ca;--text:#f3f7f7;--cyan:#84d3d5;--violet:#b0e7e8;--green:#84d3d5;--red:#ff8290}
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-width:320px;font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 10% 0%,rgba(132,211,213,.14),transparent 34rem),radial-gradient(circle at 92% 14%,rgba(132,211,213,.08),transparent 30rem),linear-gradient(180deg,#29313e 0%,#222a36 52%,#29313e 100%);line-height:1.55}
    ...
    .container{width:min(1180px,calc(100% - 40px));margin:auto;position:relative}.nav{min-height:132px;display:flex;align-items:center;justify-content:space-between}.brand{display:flex;align-items:center;text-decoration:none}.brand img{display:block;width:224px;height:auto;filter:drop-shadow(0 14px 30px rgba(0,0,0,.18))}.navlinks{display:flex;gap:24px;align-items:center}.navlinks a{color:#d1dcdf;text-decoration:none;font-size:14px}.button{padding:10px 16px;border:1px solid var(--line);border-radius:10px;background:var(--panel)}
    .hero{padding:50px 0 54px;display:grid;grid-template-columns:1.4fr .6fr;gap:54px;align-items:end}.eyebrow{display:flex;align-items:center;gap:9px;color:#c9d9dc;font-size:12px;font-weight:750;letter-spacing:.12em;text-transform:uppercase}.pulse{width:8px;height:8px;border-radius:50%;background:var(--green);box-shadow:0 0 0 6px rgba(132,211,213,.12),0 0 22px var(--green)}h1{max-width:760px;margin:18px 0;font-size:clamp(44px,7vw,76px);line-height:1;letter-spacing:-.055em}h1 span{color:transparent;background:linear-gradient(100deg,#fff 10%,var(--cyan) 58%,#c6eff0);background-clip:text;-webkit-background-clip:text}.subtitle{max-width:680px;margin:0;color:#c1cdd2;font-size:19px}.hero-actions{display:flex;flex-wrap:wrap;gap:12px;margin-top:27px}.primary{color:#1d2731!important;background:linear-gradient(110deg,var(--cyan),#b6e8e9);border-color:transparent!important;font-weight:800}.try-command{display:flex;align-items:center;justify-content:space-between;gap:18px;max-width:670px;margin-top:16px;padding:14px 16px;border:1px solid rgba(132,211,213,.34);border-radius:12px;background:rgba(27,35,47,.82);box-shadow:inset 0 1px rgba(255,255,255,.04)}.try-command code{color:#edf7f7;background:none;padding:0}.try-command span{color:#9db0b8;font-size:11px;text-transform:uppercase;letter-spacing:.09em}
    .proof{padding:24px;border:1px solid var(--line);border-radius:20px;background:linear-gradient(155deg,rgba(18,29,48,.9),rgba(9,15,27,.75));box-shadow:0 28px 80px rgba(0,0,0,.28)}.proof strong{font-size:13px}.score{margin:15px 0 8px;font-size:56px;font-weight:800;letter-spacing:-.06em}.score small{font-size:14px;font-weight:500;color:var(--muted);letter-spacing:0}.bar{height:7px;background:#25313f;border-radius:10px;overflow:hidden}.bar span{display:block;width:100%;height:100%;background:linear-gradient(90deg,var(--green),var(--cyan))}
    .social-proof{display:grid;grid-template-columns:repeat(5,1fr);margin:0 0 80px;border:1px solid var(--line);border-radius:15px;background:rgba(33,42,54,.55)}.proof-stat{padding:18px;text-align:center;border-right:1px solid var(--line)}.proof-stat:last-child{border:0}.proof-stat strong{display:block;font-size:21px}.proof-stat span{color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.08em}.product-intro{max-width:760px;margin:0 auto 35px;text-align:center}.product-intro h2,.demo-copy h2,.case-copy h2{margin:8px 0 13px;font-size:clamp(32px,5vw,48px);line-height:1.05;letter-spacing:-.045em}.product-intro p,.demo-copy p,.case-copy p{color:var(--muted)}.features{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:90px}.feature{padding:25px;border:1px solid var(--line);border-radius:17px;background:linear-gradient(145deg,rgba(42,52,65,.76),rgba(31,39,51,.66))}.feature-icon{display:grid;place-items:center;width:34px;height:34px;margin-bottom:30px;border-radius:10px;background:rgba(132,211,213,.09);color:var(--cyan);font-weight:800}.feature h3{margin:0 0 8px}.feature p{margin:0;color:var(--muted);font-size:13px}.demo-section,.case-study{display:grid;grid-template-columns:.8fr 1.2fr;gap:42px;align-items:center;margin-bottom:90px}.demo-frame{overflow:hidden;border:1px solid rgba(132,211,213,.2);border-radius:18px;background:#202833;box-shadow:0 30px 80px rgba(0,0,0,.38)}.demo-frame img{display:block;width:100%;height:auto}.case-study{grid-template-columns:1fr 1fr;padding:32px;border:1px solid rgba(255,107,122,.2);border-radius:20px;background:radial-gradient(circle at 100% 0,rgba(255,107,122,.09),transparent 50%),var(--panel)}.result-card{padding:24px;border:1px solid var(--line);border-radius:16px;background:#222b38}.result-head{display:flex;justify-content:space-between;align-items:start}.result-score{font-size:52px;font-weight:820;letter-spacing:-.06em}.blocked{padding:5px 9px;border-radius:99px;background:rgba(255,107,122,.11);color:#ff8a96;font-size:10px;font-weight:800;letter-spacing:.08em}.result-bar{height:7px;margin:12px 0 20px;border-radius:8px;background:#35414e;overflow:hidden}.result-bar span{display:block;width:72%;height:100%;background:linear-gradient(90deg,#ff6b7a,#ffc15c)}.finding-row{display:flex;justify-content:space-between;padding:9px 0;border-top:1px solid var(--line);color:#9aa9bd;font-size:12px}.finding-row b{color:var(--text)}.section-title{margin:20px 0}.section-title h2{margin:6px 0;font-size:34px;letter-spacing:-.04em}.section-title p{margin:0;color:var(--muted)}.summary{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin:22px 0}.stat{padding:20px 23px;border:1px solid var(--line);border-radius:16px;background:var(--panel)}.stat .number{font-size:36px;font-weight:780;letter-spacing:-.04em}.stat .label{font-size:13px;color:var(--muted)}.pass .number{color:var(--green)}.fail .number{color:var(--red)}
    .index-note{display:flex;gap:12px;align-items:flex-start;margin:18px 0 22px;padding:14px 16px;border:1px solid rgba(132,211,213,.18);border-radius:13px;background:rgba(132,211,213,.055);color:#b8c7da;font-size:13px}.index-note b{color:var(--cyan);white-space:nowrap}.directory-tools{display:grid;grid-template-columns:1fr 260px;gap:12px;margin-bottom:14px}.directory-tools input,.directory-tools select{width:100%;height:46px;padding:0 15px;border:1px solid var(--line);border-radius:12px;background:rgba(33,42,54,.9);color:var(--text);font:inherit;outline:none}.directory-tools input:focus,.directory-tools select:focus{border-color:rgba(132,211,213,.55);box-shadow:0 0 0 3px rgba(132,211,213,.08)}.directory-status{margin:0 0 14px;color:var(--muted);font-size:13px}.server-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.server-card{min-height:270px;padding:20px;display:flex;flex-direction:column;border:1px solid var(--line);border-radius:17px;background:linear-gradient(145deg,rgba(42,52,65,.78),rgba(31,39,51,.68));transition:.18s ease}.server-card:hover{transform:translateY(-2px);border-color:rgba(132,211,213,.34);box-shadow:0 18px 46px rgba(0,0,0,.22)}.server-card.is-hidden{display:none}.card-top,.card-footer,.card-meta{display:flex;align-items:center;justify-content:space-between;gap:10px}.index-number{color:#687890;font-size:11px;font-weight:800;letter-spacing:.1em}.evidence-chip{padding:4px 8px;border-radius:99px;background:rgba(132,211,213,.09);color:#9de2e3;font-size:10px;font-weight:750;text-transform:uppercase;letter-spacing:.06em}.server-card h3{margin:18px 0 7px;font-size:17px;line-height:1.25}.server-card h3 a{color:var(--text);text-decoration:none}.server-card code{align-self:flex-start;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8fa0b7;background:#25313f;padding:4px 7px;border-radius:6px;font-size:11px}.card-meta{justify-content:flex-start;flex-wrap:wrap;margin:14px 0 5px}.card-meta span{padding:4px 7px;border:1px solid var(--line);border-radius:7px;color:#98a8bd;font-size:10px}.server-card p{margin:8px 0 18px;color:var(--muted);font-size:12px;line-height:1.5}.card-footer{margin-top:auto;padding-top:13px;border-top:1px solid rgba(148,163,184,.1);color:#718198;font-size:10px}.card-footer span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.card-footer a{flex:none;color:var(--cyan);text-decoration:none;font-size:11px}.show-more{display:flex;margin:20px auto 55px;padding:11px 20px;border:1px solid var(--line);border-radius:11px;background:var(--panel);color:var(--text);font:inherit;font-size:13px;font-weight:700;cursor:pointer}.show-more:hover{border-color:rgba(132,211,213,.45)}.table-shell{overflow:auto;border:1px solid var(--line);border-radius:18px;background:rgba(33,42,54,.8);box-shadow:0 26px 70px rgba(0,0,0,.22)}table{width:100%;border-collapse:collapse}th{text-align:left;padding:15px 17px;background:rgba(255,255,255,.025);color:#77869d;font-size:10px;text-transform:uppercase;letter-spacing:.11em}td{padding:16px 17px;border-top:1px solid rgba(148,163,184,.1)}tbody tr:hover{background:rgba(132,211,213,.035)}code{background:#25313f;padding:3px 6px;border-radius:5px}.footer{padding:42px 0;text-align:center;color:var(--muted);font-size:13px}.footer a{color:var(--cyan);text-decoration:none}
    @media(max-width:900px){.server-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.features{grid-template-columns:1fr}.feature-icon{margin-bottom:18px}.demo-section,.case-study{grid-template-columns:1fr}.social-proof{grid-template-columns:repeat(3,1fr)}.proof-stat{border-bottom:1px solid var(--line)}}@media(max-width:820px){.hero{grid-template-columns:1fr;padding-top:34px}.proof{max-width:520px}.navlinks a:not(.button){display:none}.brand img{width:190px}.nav{min-height:118px}}@media(max-width:620px){.directory-tools{grid-template-columns:1fr}.server-grid{grid-template-columns:1fr}.server-card{min-height:230px}.social-proof{grid-template-columns:1fr 1fr}.try-command{align-items:flex-start;flex-direction:column}}@media(max-width:560px){.container{width:calc(100% - 28px)}h1{font-size:43px}.summary{grid-template-columns:1fr 1fr}.stat:last-child{grid-column:1/-1}th,td{padding:13px 12px}.subtitle{font-size:17px}.index-note{display:block}.index-note b{display:block;margin-bottom:4px}.case-study{padding:20px}.brand img{width:168px}.nav{min-height:108px}}
  </style>
</head>
<body>
  <div class="container">
