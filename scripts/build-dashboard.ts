...
<body>
  ...
  <div class="container">
    ...
    <section class="hero"><div><div class="eyebrow"><i class="pulse"></i>MCP release gate and open-source evidence</div><h1>Make the production decision <span>before agents depend on MCP.</span></h1><p class="subtitle">MCP Observatory gives platform and security teams an evidence-backed answer: approve, gate, or defer a critical MCP dependency—then keeps the decision running in CI.</p><div class="hero-actions"><a class="button primary" href="/release-gate-pilot/">Get a release decision ↗</a><a class="button" href="https://www.npmjs.com/package/@kryptosai/mcp-observatory">Run the free scan ↗</a></div><div class="audience"><a href="/release-gate-pilot/"><b>I’m approving MCP for production</b>See the fixed $15k Release Gate Pilot.</a><a href="/safety-index/"><b>I’m building an MCP server</b>Use the free CLI and public Safety Index.</a></div></div><aside class="proof"><strong>PUBLIC SAFETY INDEX · LIVE</strong><div class="score">${safetyTargets.length} <small>servers indexed</small></div><div class="bar"><span></span></div></aside></section>
    <section class="evaluation-proof" aria-labelledby="evaluation-proof-heading"><div class="evaluation-proof-header"><div class="evaluation-proof-head"><div><div class="eyebrow">Real-world proof</div><h2 id="evaluation-proof-heading">Used by engineers and security researchers.</h2></div><div class="evaluation-download-proof"><strong>14K+</strong><span>package downloads</span></div></div><div class="evaluation-proof-logos" aria-label="Organizations represented in observed evaluations"><div class="evaluation-proof-logo" aria-label="Microsoft"><img src="/proof-logos/microsoft.svg" alt="Microsoft"></div><div class="evaluation-proof-logo" aria-label="Google"><img src="/proof-logos/google.svg" alt="Google"></div><div class="evaluation-proof-logo" aria-label="Oracle"><img src="/proof-logos/oracle.svg" alt="Oracle"></div><div class="evaluation-proof-logo" aria-label="Cisco"><img src="/proof-logos/cisco.svg" alt="Cisco"></div><div class="evaluation-proof-logo" aria-label="Accenture"><img src="/proof-logos/accenture.svg" alt="Accenture"></div><div class="evaluation-proof-logo" aria-label="Cloudflare"><img src="/proof-logos/cloudflare.svg" alt="Cloudflare"></div></div><p class="evaluation-proof-note"><strong>Important:</strong> Based on observed evaluations. This does not imply customer, partnership, or endorsement relationships.</p></div></section>
