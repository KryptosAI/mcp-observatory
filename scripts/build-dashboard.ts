...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-width:320px;font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 12% 0%,rgba(68,97,255,.2),transparent 32rem),radial-gradient(circle at 88% 12%,rgba(45,212,191,.12),transparent 28rem),var(--bg);line-height:1.55}
    ...
    @media(max-width:900px){.server-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.features{grid-template-columns:1fr}.feature-icon{margin-bottom:18px}.team-section,.demo-section,.case-study{grid-template-columns:1fr}}@media(max-width:820px){.hero{grid-template-columns:1fr;padding-top:34px}.proof{max-width:520px}.navlinks a:not(.button){display:none}.brand img{width:240px}.nav{min-height:160px}}@media(max-width:620px){.directory-tools{grid-template-columns:1fr}.server-grid{grid-template-columns:1fr}.server-card{min-height:230px}.try-command{align-items:flex-start;flex-direction:column}}@media(max-width:560px){.container{width:calc(100% - 28px)}h1{font-size:43px}.summary{grid-template-columns:1fr 1fr}.stat:last-child{grid-column:1/-1}th,td{padding:13px 12px}.subtitle{font-size:17px}.index-note{display:block}.index-note b{display:block;margin-bottom:4px}.case-study,.team-section{padding:20px}.brand img{width:200px}.nav{min-height:136px}}
  </style>
</head>
<body>
  <div class="container">
    <nav class="nav"><a class="brand" href="/" aria-label="MCP Observatory home"><img src="/mcp-observatory-logo-v2.png" alt="MCP Observatory"></a><div class="navlinks"><a href="#index">Safety Index</a><a href="#teams">For Teams</a><a href="/safety-index/">Server Reports</a><a class="button" href="https://www.npmjs.com/package/@kryptosai/mcp-observatory">Install ↗</a></div></nav>
    ...
    <section class="team-section" id="teams"><div><div class="eyebrow">For platform &amp; security teams</div><h2>Make a defensible decision before agents gain tool access.</h2><p class="subtitle">MCP Readiness Reviews turn private MCP inventories into a clear approve, gate, or defer decision—with reproducible evidence and owner-ready next steps.</p><div class="hero-actions"><a class="button primary" href="https://github.com/KryptosAI/mcp-observatory/blob/main/docs/paid-pilot-offer.md">View the Readiness Review ↗</a><a class="button" href="https://github.com/KryptosAI/mcp-observatory">Read the documentation ↗</a></div></div><div class="team-points"><div><b>Private evidence.</b> Keep internal targets, findings, and remediation plans out of public reports.</div><div><b>Fits existing CI.</b> Send normalized findings to SARIF and GitHub Code Scanning.</div><div><b>Safe by default.</b> Review tool surfaces without destructive probes or production credentials.</div></div></section>
